...
import resume from '../media/vinit_kumar_Resume.pdf'
                  ...
                  <Col lg={4} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <a href="https://www.linkedin.com/in/vinitkr567/" target="_blank" rel="noreferrer noopener">
                          <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
                            <FontAwesomeIcon className="dark" size="lg" icon={faLinkedin}/> Vinit Kumar
                          </Button>
                        </a>
